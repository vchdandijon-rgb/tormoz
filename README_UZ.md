...
- o‘rnatuvchi `Tormoz-sinovi-Setup-1.4.2-x64.exe`;
- o‘rnatmasdan ishlaydigan `Tormoz-sinovi-Portable-1.4.2-x64.exe`.
...
## 1.4.2 versiyadagi mobil moslashuv

- 820 pikselgacha bo‘lgan ekranlarda sxema va texnik izoh paneli ustma-ust tushmaydigan alohida qatorlarga ajratildi.
- Sxema yuqorida to‘liq ko‘rinadi, jarayon hamda element izohlari esa pastdagi bo‘sh maydondan foydalanadi.
- Mobil simulator qat’iy ekran balandligidan chiqarilib, ortiqcha bo‘sh maydonsiz tabiiy sahifa balandligiga o‘tkazildi.
- Brauzerda `Chiqish` tugmasi bosh menyuga qaytaradi; Electron EXE’dagi oynani yopish xatti-harakati o‘zgarmadi.
- Kompyuter uchun mavjud katta sxema va o‘ng texnik panel dizayni saqlandi.
